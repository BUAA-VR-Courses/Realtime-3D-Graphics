...
{
	// TODO 4.2 : Complete the following shadow mapping calculations
...
void main() {
	...
	// TODO 4.1 : Complete the following shadow mapping calculations
	...
	// TODO 4.1 : Modify the output of frag color
